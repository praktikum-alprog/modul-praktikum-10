...
//Belah Ketupat
void luas_belahketupat(float diagonal1, float diagonal2);
...
int main(){
	...
	switch(pilihan){
		...
		case 2: 
			...
			printf("\nMasukan Diagonal 1 : ", diagonal1);
			scanf("%f", &diagonal1);
			printf("Masukan Diagonal 2 : ", diagonal2);
			scanf("%f", &diagonal2);
			printf("Masukan sisi : ", sisi);
			scanf("%f", &sisi);
			luas_belahketupat(diagonal1, diagonal2);
