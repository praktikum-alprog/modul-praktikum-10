...
int main(){
	...
	do{
		...
		printf("|==========================================|\n");
		printf("|Total jam kerja non lembur | %9d jam|\n", hari.jam);
		printf("|---------------------------+--------------|\n");
		printf("|Total jam lembur           | %9d jam|\n", hari.jam_lembur);
		printf("|---------------------------+--------------|\n");
		printf("|Total jam kerja sehari     | %9d jam|\n", hari.total_jam);
		printf("|---------------------------+--------------|\n");
		printf("|Total gaji non lembur      | Rp.%10d|\n", hari.gaji);
		printf("|---------------------------+--------------|\n");
		printf("|Total gaji lembur          | Rp.%10d|\n", hari.gaji_lembur);
		printf("|---------------------------+--------------|\n");
		printf("|Total gaji dalam sehari    | Rp.%10d|\n", hari.total_gaji);
		printf("+---------------------------+--------------+\n");
