...
int main(){
	...
	do{
		...
		printf("|==========================================|");
		printf("\n|Panjang sisi kubus     | %-17d|", kbs_s.sisi);
		printf("\n|-----------------------+------------------|");
		printf("\n|Luas permukaan kubus   | %-17d|", kbs_s.luas_permukaan);
		printf("\n|-----------------------+------------------|");
		printf("\n|Volume kubus           | %-17d|", kbs_s.volume);
		printf("\n|==========================================|");
		printf("\n|           Kubus dengan union             |\n");
		printf("|==========================================|");
		kbs_u.nilai = kbs_s.sisi;
		printf("\n|Panjang sisi kubus     | %-17d|", kbs_u.nilai);
		printf("\n|-----------------------+------------------|");
		kbs_u.nilai = 6*(kbs_u.nilai * kbs_u.nilai);
		printf("\n|Luas permukaan kubus   | %-17d|", kbs_u.nilai);
		printf("\n|-----------------------+------------------|");
		kbs_u.nilai = kbs_s.sisi * kbs_s.sisi * kbs_s.sisi;
		printf("\n|Volume kubus           | %-17d|", kbs_u.nilai);
		printf("\n|==========================================|\n");
		printf("\n|==========================================|");
		printf("\n|Ukuran memori pada kubus struct  | %-7d|\n", sizeof(kbs_s));
		printf("|==========================================|");
		printf("\n|Ukuran memori dari kubus union   | %-7d|\n", sizeof(kbs_u));
		printf("|==========================================|");
